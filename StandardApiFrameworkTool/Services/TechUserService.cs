    ...
    public static class TechUserService
    {
            ...
            string baseAddress)
        {
            ...
            try
            {
                ...
                var response = await client.PostAsync("general/v2/techUserEnrolment", new StringContent(jsonRequest, Encoding.UTF8, "application/json"));
            ...
            X509Certificate2 x509Certificate2)
        {
            try
            {
                ...
                using (HttpClient client = new HttpClient(handler))
                {
                    ...
                    // Send HTTP POST request
                    var response = await client.PostAsync($"{baseAddress}/general/v2/saf-receivers", new StringContent(jsonRequest, Encoding.UTF8, "application/json"));
